...
const ManageLoans = () => {
  ...
  const averageHealthFactor =
    loans.length > 0
      ? loans.reduce((sum, loan) => sum + loan.healthFactor, 0) / loans.length
      : 0;
  ...
  const getHealthFactorBadge = (factor: number) => {
    ...
    if (factor >= 1.5)
      return (
        <Badge className="bg-yellow-100 text-yellow-800">Peringatan</Badge>
      );
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Monitor dan kelola semua pinjaman aktif Anda.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    Rp {totalLoanAmount.toLocaleString("id-ID")}
                  </div>
                  <p className="text-xs text-muted-foreground">
                    {loans.length} pinjaman aktif
                  </p>
                </CardContent>
              </Card>
              <Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Status {averageHealthFactor >= 1.8 ? "aman" : "peringatan"}
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>
                Detail semua pinjaman yang sedang berjalan.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {loading ? (
                            ...
                            <div>
                              <div className="flex justify-between mb-2">
                                ...
                                <span className="text-sm">
                                  {Math.round(
                                    (1 - loan.outstanding / loan.amount) * 100
                                  )}
                                  %
                                </span>
                              </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center">
                <Calendar className="w-5 h-5 mr-2" /> Riwayat Transaksi Pinjaman
              </CardTitle>
              <CardDescription>
                Aktivitas terbaru terkait pinjaman Anda.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {loading ? (
      ...
      <DialogContent>
        ...
        <div className="space-y-4 py-4">
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="full" className="cursor-pointer">
                  Pelunasan (Rp{" "}
                  {selectedLoan?.outstanding.toLocaleString("id-ID")})
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="monthly" className="cursor-pointer">
                  Cicilan Bulanan (Rp{" "}
                  {selectedLoan?.monthlyPayment.toLocaleString("id-ID")})
                </Label>
              </div>
              <div className="flex items-center space-x-2">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <div className="flex justify-between">
              ...
              <span className="font-medium">
                Rp {getRepaymentAmount().toLocaleString("id-ID")}
              </span>
            </div>
            <div className="flex justify-between">
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={getRepaymentAmount() <= 0 || isProcessingPayment}
          >
